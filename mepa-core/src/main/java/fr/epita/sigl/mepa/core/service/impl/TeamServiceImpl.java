...
public class TeamServiceImpl implements TeamService {
    ...
    @Override
    public List<Team> getAllOrderTeamsByPhase(Long phaseID) {
        return this.teamDao.getOrderByPhaseId(phaseID);
    }

    @Override
    public HashMap<String, Long> getRangeByPhaseId(Long phaseID, Team team) {
        HashMap<String, Long> result = new HashMap<String, Long>();

        List<Team> allOrder = this.getAllOrderTeamsByPhase(phaseID);
