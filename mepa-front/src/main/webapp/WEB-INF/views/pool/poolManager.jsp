...
<div>
	<div class="page-header">
        ...
        <c:if test="${not empty pool.games}">
            <a href="https://twitter.com/intent/tweet" data-text="Poule ${pool.name} du tournoi ${pool.tournament.name}" class="twitter-mention-button" data-lang="en">Tweeter les matchs</a>
