        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container-fluid">
                ...
                <sec:authorize access="isAnonymous()">
                    <button type="button" class="btn btn-primary navbar-btn navbar-right tip" data-toggle="modal"
                            role="button" href="#login_modal"><span class="hidden-xs"><spring:message
                            code="login"/></span>&nbsp;<i class="glyphicon glyphicon-log-in"></i></button>
                </sec:authorize>
                <sec:authorize access="isAuthenticated()">
                    <a href="${pageContext.request.contextPath}/j_spring_security_logout" type="button"
                       class="btn btn-danger navbar-btn navbar-right tip" role="button"><span
                            class="hidden-xs"><spring:message code="logout"/></span>&nbsp;<i
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="form-control" name="j_username" id="inputId"
                                       placeholder="${loginPlaceholder}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword" class="col-sm-3 control-label"><spring:message
                                    code="form.passwordLabel"/></label>

                            <div class="col-sm-8">
                                <spring:message code="form.passwordPlaceholder" var="passwordPlaceholder"/>
                                <input type="password" class="form-control" name="j_password" id="inputPassword"
