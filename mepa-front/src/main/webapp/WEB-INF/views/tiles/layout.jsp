...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/js/DataTables-1.10.0/media/css/jquery.dataTables.css"
          type="text/css"/>
    ...
    <script type="application/javascript"
            src="${pageContext.request.contextPath}/js/DataTables-1.10.0/media/js/jquery.dataTables.js"></script>
            ...
            <div class="col-md-3">
                <div>
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        <li class="active"><a href="#facebook" role="tab" data-toggle="tab"><img
                                src="${pageContext.request.contextPath}/img/facebook.png"/>&nbsp; Facebook</a></li>
                        <li><a href="#twitter" role="tab" data-toggle="tab"><img
                                src="${pageContext.request.contextPath}/img/twitter.png"/>&nbsp;Twitter</a></li>
                    </ul>
                </div>
                <div class="tab-content">
                    <div class="tab-pane active" id="facebook">
                        <div class="fb-like-box" data-href="https://www.facebook.com/643322352412195" data-width="100%"
                             data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="true"
                             data-show-border="true"></div>
                    </div>
                    <div class="tab-pane" id="twitter">
                        <a class="twitter-timeline" href="https://twitter.com/MepaSigl"
                           data-widget-id="489393956145225728">Tweets de @MepaSigl</a>
                        <script>!function (d, s, id) {
