...
public class PoolController {
    ...
    @Autowired
    private JoinedGameTeamService joinedGameService;
    ...
    public String updateGame(HttpServletRequest request, ModelMap modelMap) {
        ...
        Game g = this.gameService.getGameById(gameID);
